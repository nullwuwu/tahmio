...
const defaultInstance = new Tank()
...
const tank = bind(Tank.prototype.request, defaultInstance)

tank.defaults = defaultInstance.defaults
tank.interceptors = defaultInstance.interceptors
